...
public class EpisodeConstants {
    public static final Episode JOHN_SMITH_EPISODE = Episode.builder()
            .author("Claimant")
            .date("03/28/2022")
            .notes("""
                    Pg 28: Does 15 minutes ab routine.  Sometimes 20 something minutes.
                    Pg 42, had minor invasive mid-back surgery in November of 2021.\s
                    Pg 54: Has had RFA performed to the neck twice.
                    Pg 55: Relief of mid back pain from RFA for 3-4 months.      \s
                    Pg 89: Has worked 50 hours a week for the past 4 months""")
            .build();

    public static final Episode STRONG_HEALTH_EPISODE = Episode.builder()
            .author("Emergency Room Provider")
            .type("Emergency Room")
            .date("01/12/2020")
            .time("02:39 pm")
            .notes("c/o left knee lac from last night.  Seen last nite as well.")
            .build();

    public static final Episode STRONG_HEALTH_EPISODE_2 = Episode.builder()
            .author("Fernando Wargas MD")
            .type("X-Ray")
            .date("01/12/2020")
            .notes("Right Tib/Fib: Soft tissue swelling laterally at the ankle.")
            .build();

    public static final Episode ROBERT_CHASE_EPISODE = Episode.builder()
            .date("03/31/2022")
            .notes("""
                    From attorney
    ...
    public static final Episode PAIN_EXPERTS_MR_EPISODE = Episode.builder()
            .type("Operation")
            .date("08/27/2021")
            .notes("""
    ...
    public static final Episode PAIN_EXPERTS_MR_EPISODE_2 = Episode.builder()
            .author("Christopher Jacobson MD")
            .type("Physiatry")
            .date("08/31/2021")
            .notes("""
                    Removal of drain.
    ...
    public static final Episode PAIN_EXPERTS_MR_EPISODE_3 = Episode.builder()
            .type("Orthopaedic")
            .date("09/09/2021")
            .notes("Postop from thoracic laminotomy. Pain, 5")
            .build();

    public static final Episode PAIN_EXPERTS_MR_EPISODE_4 = Episode.builder()
            .type("Orthopaedic")
            .date("10/07/2021")
            .notes("Postop.Pain does not radiate. No restrictions at this point. Activities as tolerated.")
            .build();

    public static final Episode PAIN_EXPERTS_MR_EPISODE_5 = Episode.builder()
            .author("Kira Nightley PA")
            .type("Medical")
            .date("08/23/2021")
            .notes("Preoperative evaluation.")
            .build();

    public static final Episode CENTRAL_BAY_MEDICAL_AND_REHAB_CENTER_EPISODE = Episode.builder()
            .author("Lawrence Kutner MD")
            .type("MRI")
            .date("01/17/2020")
            .notes("""
                                        Central Bay Imaging
    ...
    public static final Episode CENTRAL_BAY_MEDICAL_AND_REHAB_CENTER_EPISODE_2 = Episode.builder()
            .author("Central Bay Medical & Rehab Center")
            .type("Billing")
            .notes("""
    ...
    public static final Episode BEST_SIDE_MEDICAL_GROUP_EPISODE = Episode.builder()
            .author("Eva Adams MD")
            .type("Medical")
            .date("01/15/2020")
            .notes("""
    ...
    public static final Episode EPISODE_13153612 = Episode.builder()
            .author("Claimant")
            .date("10/23/2020")
            .notes("""
                    13th Circuit
